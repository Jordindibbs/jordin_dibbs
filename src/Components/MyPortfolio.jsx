import dibbs_gaming from "../Assets/dibbs_gaming.png";
      ...
      <div className="portfolio--container-box">
        ...
        <div>
          <button className="btn btn-github">
            ...
            <a href="https://github.com/Jordindibbs" target="blank">
              Visit My Github
            </a>
          </button>
        </div>
      ...
      <div className="portfolio--section--container">
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={dibbs_gaming} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">
                Dibbs Gaming E-Commerce
              </h3>
              <p className="text-md">
                Full featured shopping cart, product reviews and ratings, user
                profile with orders, product pagination and PayPal / credit card
                integration. Also has admin functionality such as product
                management, user management and Order details page
              </p>
              <br />
              <p className="text-md">
                Built with: MongoDB, Express.js, React, Node.js and Redux
              </p>
            </div>
            <p className="text-sm portfolio--link">
              <a href="https://dibbs-gaming.onrender.com/" target="blank">
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={Tracker} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">
                Warhammer Objective Tracker
              </h3>
              <p className="text-md">
                Objective tracker for the tabletop game Warhammer 40k 9th
                edition. <br />
                Assists players in managing current score per round and other
                tactical information such as current faction and what objectives
                are being played.
              </p>
              <br />
            ...
            <p className="text-sm portfolio--link">
              <a
                href="https://jordindibbs.github.io/Warhammer40k-Tracker/"
                target="blank"
              >
                View Deployed Project
              </a>
        ...
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={todo} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">React To-Do List</h3>
              <p className="text-md">
                To-do app made as part of my react course final, with the
                ability to add, remove and check off tasks as needed.
                <br />
                List items are stored in local function, allowing us to access
                the same list upon refresh.
              </p>
              <br />
              <p className="text-md">Built with: React and Node.js</p>
            </div>
            <p className="text-sm portfolio--link">
              <a href="https://github.com/Jordindibbs/To-Do-App" target="blank">
